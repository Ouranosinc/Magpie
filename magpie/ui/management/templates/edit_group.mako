...
<h3>Members</h3>
%if edit_membership_new_usr_error:
    <div class="alert alert-warning alert-visible" id="EditMembership_WarningFailureAlert">
        ...
        <p>
            Failed to add the user ${edit_membership_new_usr_error} to the group.
...
%endif
%if edit_membership_pending_usr_success:
    <div class="alert alert-success alert-visible" id="EditMembership_SuccessAlert">
        ...
        <p>
            Successfully requested to add the user ${edit_membership_pending_usr_success} to the group.
