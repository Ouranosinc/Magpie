...
.. |commits-since| image:: https://img.shields.io/github/commits-since/Ouranosinc/Magpie/5.0.0.svg
    :alt: Commits since latest release
    :target: https://github.com/Ouranosinc/Magpie/compare/5.0.0...master

.. |version| image:: https://img.shields.io/badge/tag-5.0.0-blue.svg?style=flat
    :alt: Latest Tag
    :target: https://github.com/Ouranosinc/Magpie/tree/5.0.0
...
.. |github_tagged| image:: https://img.shields.io/github/actions/workflow/status/Ouranosinc/Magpie/tests.yml?label=5.0.0&branch=5.0.0
    :alt: Github Actions CI Build Status (latest tag)
    :target: https://github.com/Ouranosinc/Magpie/actions?query=workflow%3ATests+branch%3A5.0.0
...
.. |docker_semver_tag| image:: https://img.shields.io/docker/v/pavics/magpie?label=version&sort=semver
    ...
    :target: https://hub.docker.com/r/pavics/magpie/tags?page=1&ordering=last_updated&name=5.0.0
